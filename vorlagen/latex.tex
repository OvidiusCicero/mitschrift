...
\usepackage{multicol}
\usepackage{enumitem}
%\setlist{format=\scshape,\rmfamily}
\setlist{format=\rmfamily\scshape}
...
%Otherwise it does not work – I know it contradicts the build file
	...
	$else$
		...
		$if(nicetitle)$
			...
			$if(landscape)$
				{\Huge $title$ \\}
				\vspace{0.5cm}
				{\Large Protokolliert von $author$\\}
				\vspace{0.5cm}
				{\Large vom $date$\\}
				\vspace{0.5cm}
